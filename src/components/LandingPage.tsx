      ...
      <section className="py-8 bg-[#171a21] border-y border-[#2a475e]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[#1b2838] p-3 rounded-xl border border-[#2a475e] hover:border-[#66c0f4] transition-colors">
              <Clock className="w-7 h-7 text-[#66c0f4] mb-2.5" />
            ...
            <div className="bg-[#1b2838] p-3 rounded-xl border border-[#2a475e] hover:border-[#66c0f4] transition-colors">
              <Sparkles className="w-7 h-7 text-[#66c0f4] mb-2.5" />
            ...
            <div className="bg-[#1b2838] p-3 rounded-xl border border-[#2a475e] hover:border-[#66c0f4] transition-colors">
              <TrendingDown className="w-7 h-7 text-[#66c0f4] mb-2.5" />
